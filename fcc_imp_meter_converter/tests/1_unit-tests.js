...
suite('Unit Tests', function(){
  ...
  suite('Function convertHandler.getUnit(input)', function() {
    ...
    test('Unknown Unit Input', function(done) {
      assert.equal(convertHandler.getUnit('gall'), 'invalid unit');
      assert.equal(convertHandler.getUnit('kgss'), 'invalid unit');
      assert.equal(convertHandler.getUnit('Mi'), 'invalid unit');
      done();
    });  
